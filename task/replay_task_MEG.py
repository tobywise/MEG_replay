...
class ReplayExperiment(object):
    ...
    def __init__(self, config=None):
        ...
        self.parallel_port2 = ParallelPort(port=000, test=self._parallel_port)
    ...
    def __run_task(self, test=False, instructions=None, trial_info=None, show_instructions=True, show_intro=False):
        ...
        for i in range(n_trials):  # TRIAL LOOP - everything in here is repeated each trial
            ...
            trigger_dict = {'Planning': False, 'Move_entering': False, 'State_0': False, 'State_1': False, 'State_2': False,
            ...
            while continue_trial:  # run the trial
                ...
                if trial_info['trial_type'][i] == 1:
                    ...
                    if t < outcome_only_change_times[1]:
                        ...
                        self.send_trigger(self.parallel_port2, 0, trigger_dict['Outcome_only_warning'])
                    ...
                    # Show outcome
                        ...
                        self.send_trigger(self.parallel_port2, 0, trigger_dict['Outcome_only_outcome'])
                    ...
                    if change_times[0] <= t < change_times[1]:
                        ...
                        self.send_trigger(self.parallel_port2, 0, trigger_dict['Planning'])
                    ...
                    # Move entering warning
                        ...
                        self.send_trigger(self.parallel_port2, 0, trigger_dict['Move_entering'])
                    ...
                    # Show moves
                        ...
                        # Give warnings if wrong moves entered
                        ...
                        # Show moves
                            ...
                            for n, state in enumerate([0] + moves):
                                ...
                                self.send_trigger(self.parallel_port2, 0, trigger_dict['State_{0}'.format(n)])
                    ...
                    # Rest period
                        ...
                        self.send_trigger(self.parallel_port2, 0, trigger_dict['Rest'])
                ...
                if not continue_trial:
                    ...
                    if trial_info['trial_type'][i] == 1:
                        ...
                        self.response_data['Reward_received'] = outcome_only
                        ...
                        if len(moves) == self.n_moves:
                            self.response_data['Reward_received'] = outcome[state]
                            self.response_data['Shock_received'] = shock_outcome[state]
                        else:
                            self.response_data['Reward_received'] = np.nan
    ...
    def send_trigger(self, port, data, set):
        ...
        if not set:
            self.win.callOnFlip(port.setData(data))
        else:
            self.win.callOnFlip(port.setData(0))
